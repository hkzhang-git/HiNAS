...
class Cell(nn.Module):
    ...
    def __init__(self, blocks, C, primitives, empty_H1=False, affine=True):
        """
        Arguments:
            blocks (int): number of blocks in cell
            inp (int): channels, reshaped and weighted by previous cells
...
class FixCell(nn.Module):
    def __init__(self, genotype, C, repeats=2):
        """
        Arguments:
